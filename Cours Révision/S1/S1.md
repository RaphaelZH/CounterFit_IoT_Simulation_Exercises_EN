...
- Partitionnez les données et les calculs sur plusieurs machines
...
| ![La différence entre laisser un serveur ou un client vérifier les formulaires au fur et à mesure qu'ils sont remplis](./Figures/03.%20Figure%203.png) |
|:------------------------------------------------------------------------------------------------------------------------------------------------------:|
|           **Figure 3 : La différence entre laisser un serveur ou un client vérifier les formulaires au fur et à mesure qu'ils sont remplis**           |
